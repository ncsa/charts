...
| [geoserver](charts/geoserver) | 1.4.0 | 2.28.3 | Open source server for sharing geospatial data |
| [mlflow](charts/mlflow) | 1.2.1 | 2.2.1 | Open source platform for the machine learning lifecycle |
| [uptime-kuma](charts/uptime-kuma) | 1.4.1 | 2.2.1 | Fancy self-hosted monitoring tool with 90+ notification integrations |
