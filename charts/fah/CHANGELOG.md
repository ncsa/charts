...
### Updated
- Updated application from 8.5.5 to 8.5.6
...
### Changed
- Ensured imagetag matches appVersion for consistency

## [1.0.1] - 2025-11-02

### Fixed
- Fixed GPU DaemonSet to correctly use GPU resources

### Changed
- Auto-updated chart README documentation
